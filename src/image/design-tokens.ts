...
/**
 * Core color palette - dark theme with carefully calibrated contrast ratios
 * All text colors meet WCAG AA standards (4.5:1 minimum contrast)
 */
export const colors = {
  // Backgrounds
  background: "#0A0A0A", // True black for OLED-friendly display
  surface: "#161616", // Elevated surface for cards
  surfaceHover: "#1C1C1C", // Hover state for surfaces
  surfaceBorder: "#262626", // Subtle border for depth

  // Text hierarchy (contrast ratios against #0A0A0A)
  text: {
    primary: "#FAFAFA", // 19.4:1 - Primary content
    secondary: "#E5E5E5", // 15.8:1 - Secondary content
    tertiary: "#A3A3A3", // 8.1:1 - Labels and captions
    muted: "#737373", // 4.9:1 - Footer/subtle text
    disabled: "#525252", // 3.0:1 - Disabled states
  },
  ...
  // Heatmap colors - grayscale progression (7 levels: 0-6)
  heatmap: {
    empty: "#1A1A1A", // No activity
    level1: "#2D2D2D", // Very low
    level2: "#424242", // Low
    level3: "#5C5C5C", // Medium-low
    level4: "#7A7A7A", // Medium
    level5: "#9E9E9E", // Medium-high
    level6: "#C4C4C4", // High
